...
export default function TimePolicyAlert({ isOpen, onClose, type, message }) {
  ...
  const styles = {
    ...
    warning: {
      ...
      buttonBg: 'bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-700 hover:to-yellow-700',
